...
<html>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <!-- Header -->
      <?php $this->load->view('admin/template/header/main'); ?>

      <!-- Left side column-->
      <?php $this->load->view('admin/template/left_column/main') ?>

      <!-- Right side column (The main body) -->
      <?php $this->load->view('admin/template/right_column/main') ?>

      <!-- Footer -->
      <?php $this->load->view('admin/template/footer/main'); ?>
